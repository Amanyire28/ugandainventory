    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8">
        ...
        <form action="{{ route('cashier.invoices.markPaid', $invoice->id) }}" method="POST">
            ...
            <div class="flex gap-3">
                ...
                <button type="submit" id="cashierConfirmBtn"
                    class="flex-1 px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 font-bold flex items-center justify-center">
                    ...
                    <span id="cashierBtnText"><i class="fas fa-check mr-1"></i> Confirm Payment</span>
                </button>
            </div>
        </form>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.querySelector('#payModal form');
    if (form) {
